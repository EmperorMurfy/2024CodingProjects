...
// Name: Mason Z.
// Date: Oct 10, 2023 at 4:10PM
// Description: arrays project with four different programs in methods
...
public class ArrayProject {
	...
	// name: number sorter 
	// description: takes ten numbers and sorts it by negative, odd, and even
	// parameter: none
	// return: void
	...
	// name: average and the number greater than the average
	// description: take 10 numbers, find average, then output average, then find all the numbers greater than average inputted and list
	// parameter: none
	// return value: void
	public static void averageGreater() {
	...
	// name: average of the score with highest and least removed 
	// description: score average - evaluate 8 amount of numbers and remove the highest and lowest scores, then find the average
	// parameters: none
	// return: void
	...
	// name: nim
	// description: game of nim - simple game of taking stones until the last stone remains, whoever takes last stone wins
	// parameters: none
	// return: void
	...
	public static void main(String[] args) {
		...
		for (int i = 1; i < 2; i++) {
			...
			// exit
				...
				System.out.println("Please input either 1, 2, 3, 4 to choose a program or press 9 to exit!");
			i=0;
			}
